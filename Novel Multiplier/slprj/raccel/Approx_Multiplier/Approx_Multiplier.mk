...
MODEL                = Approx_Multiplier
MODULES              = rt_logging_simtarget.c Approx_Multiplier.c Approx_Multiplier_capi.c Approx_Multiplier_data.c Approx_Multiplier_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Approx_Multiplier.exe
MAKEFILE             = Approx_Multiplier.mk
MATLAB_ROOT          = D:/MATLAB
ALT_MATLAB_ROOT      = D:/MATLAB
START_DIR            = C:/Users/PC/Desktop/ENGINE~1/FYP/Models/NOVELM~1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Approx_Multiplier_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Approx_Multiplier \
