...
( char_T * ) ( & rtB . ns4p5qffbs [ 0 ] ) , 8 , 0 , 548352 } , { ( char_T * )
( & rtDW . fh1xf5ew32 . TimePtr ) , 11 , 0 , 33 } , { ( char_T * ) ( & rtDW .
ntvaixwdrn . PrevIndex ) , 10 , 0 , 16 } } ; static DataTypeTransitionTable
rtBTransTable = { 3U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . FromWorkspace7_Time0 [ 0 ] )
, 0 , 0 , 1032226 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
