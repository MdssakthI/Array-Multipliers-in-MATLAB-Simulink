...
( char_T * ) ( & rtB . cefaqd4mmo [ 0 ] ) , 8 , 0 , 1114112 } , { ( char_T *
) ( & rtB . jvksohy2jj ) , 8 , 0 , 7 } , { ( char_T * ) ( & rtDW . oxtg0nrans
. TimePtr ) , 11 , 0 , 33 } , { ( char_T * ) ( & rtDW . anbyqeqhho ) , 10 , 0
, 48 } } ; static DataTypeTransitionTable rtBTransTable = { 4U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . FromWorkspace7_Time0 [ 0 ] ) , 0 , 0 , 2097192 } , { (
