...
( char_T * ) ( & rtB . icmeug23yd [ 0 ] ) , 8 , 0 , 1179648 } , { ( char_T *
) ( & rtDW . pvltcsg3fd . TimePtr ) , 11 , 0 , 34 } , { ( char_T * ) ( & rtDW
. moidzuewht . PrevIndex ) , 10 , 0 , 16 } } ; static DataTypeTransitionTable
rtBTransTable = { 3U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . FromWorkspace4_Time0 [ 0 ] )
, 0 , 0 , 2097187 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
